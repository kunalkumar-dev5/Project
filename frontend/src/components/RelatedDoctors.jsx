    ...
    return (
        <div>
            ...
            <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
                ...
                <button onClick={() => { navigate('/doctors'); window.scrollTo(0, 0); } } style={{ backgroundColor: '#5f6FFF' }} className='text-white px-8 py-3 rounded-full font-light cursor-pointer hover:opacity-90 transition border-none '>More</button>
            </div>
        </div>
    );
}
